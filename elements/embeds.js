const { EmbedBuilder, Message, ClientUser } = require('discord.js');

const embeds = {

    // fixEmbed : COMANDO DISABILITATO
    //     new EmbedBuilder()
    //     .setColor('#0099ff')
    ...
    userFix :
            new EmbedBuilder()
            .setColor('#ff4444')
            .setTitle('Prova ad chiedere al nostro bot!')
            .setDescription(
    ...
    helpEmbed :
	        ...
	        .addFields(
                ...
                { name: '📂\xa0 Repository', value: '[Codice sorgente](https://github.com/BlenderItaliaHub/Suzanne-Bot)', inline: true },
    ...
    chatGPT : 
        ...
        .setColor('#ffffff')
        .setTimestamp()
        .setFooter({ text: 'La risposta è stata generata automaticamente da ChatGPT, ci scusiamo per eventuali errori', iconURL: 'https://cdn.discordapp.com/attachments/824587918868873278/1061772180918120538/fdfffc__1_-removebg-preview.png'}),
}
